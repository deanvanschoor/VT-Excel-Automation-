...
* The file path > file_path_func
* The sheet name > sheet_name_func
```Python
def clear_sheet(file_path_func,sheet_name_func): 

Ad Hoc Requirements - There is one instance where a formula has to be added to the input data and filtered before being added to the sheet.
